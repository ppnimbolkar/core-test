...
public class TextFileTest
{
	public static void main(String[] args)
	{
		...
		staff[0] = new Employee("dante Cracker", 75000, 1987, 12, 15);
		staff[1] = new Employee("dicer Hacker", 50000, 1989, 10, 1);
		staff[2] = new Employee("antonio Tester", 40000, 1990, 3, 15);
	 ...
	 * @param emp[loyees an array of employees
...
class Employee
{
	...
	/**
	 * Reads employee data from buffered reader
	 * @param in the scanner
	 */
