...
public class zip_proto
{
	public static void main(String[] args)
	{
		EventQueue.invokeLater(new Runnable()
		{
			public void run()
			{
				zipprotoFrame frame = new zipprotoFrame();
...
/**
* Frame with a text area to show content of file inside the zip archive, a combo box to select different files in the archive, and a menu to load a new archive.
*/

class zipprotoFrame extends JFrame
{
	public zipprotoFrame()
	{
		setTitle("Zip Proto");
		...
		openItem.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent event)
			{
				...
				int r = chooser.showOpenDialog(zipprotoFrame.this);
	...
	/**
	 * Scans the content of the ZIP archive and populates the combo box.
	 */
