...
public class server_info
{
	public static void main(String[] args)
	{
		EventQueue.invokeLater(new Runnable()
		{
			public void run()
			{
				JFrame frame = new server_infoFrame();
...
class server_infoFrame extends JFrame
{
	/**
	 * POST request and returns the server response.
	 * @param wrlString the url POST to
	 * @param nameValuePairs a map of name/value pairs to supply the request.
